Feature: Delete To-Do Item
  ...
  Scenario: Delete a specific to-do item
    Given a to-do item exists for deleting with ID "1"
    When I send a DELETE request for the to-do item with ID "1"
    Then the system should remove the to-do item with ID "1"
